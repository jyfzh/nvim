...
_G.packer_plugins = {
  ...
  fd = {
    loaded = true,
    path = "/home/jyf/.local/share/nvim/site/pack/packer/start/fd",
  ...
  ["nvim-lsp-installer"] = {
    ...
    loaded = true,
    path = "/home/jyf/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ripgrep = {
    loaded = true,
    path = "/home/jyf/.local/share/nvim/site/pack/packer/start/ripgrep",
